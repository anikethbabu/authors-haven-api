...
DJANGO_APPS = [
    ...
    "django.contrib.sites",  # Optional sites framework used as a hook for associating objects and functionality to a particular webiste. Holds domain names and "verbose names"
]
...
LOGGING = {
    ...
    "formatters": {
        "verbose": {
            ...
            "%(process)d %(thread)d %(message)s"  # This setups logging verbose formatter for more info visit https://docs.djangoproject.com/en/5.0/topics/logging/
        }
    },
    "handlers": {
        "console": {
